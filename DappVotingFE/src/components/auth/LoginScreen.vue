<template>
    <div
      ...
      <div
        class="bg-cover bg-[url('https://library.unc.edu/wp-content/uploads/2024/02/2024_Elections_Workshop_FeatureBlog.png')] bg-center object-fill desktop:rounded-tr-xl sm:rounded-bl-xl max-sm:rounded-bl-xl max-sm:py-5 desktop:w-1/2 max-sm:w-full sm:w-full rounded-br-xl flex flex-col gap-4 justify-center items-center">
