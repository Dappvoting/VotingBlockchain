<template>
  <div>
    <div class="bg-black py-2">
      <div class="flex gap-4 justify-between items-center mx-auto desktop:w-[1400px] max-sm:w-full desktop:px-0 text-white">
    ...
    <div class="bg-white">
      <div class="flex items-center justify-between mx-auto desktop:w-[1400px] max-sm:w-full desktop:px-0">
        <div>
          <img class="h-20 w-full max-sm:w-[50px] text-white z-10" src="../../assets/images/HomePage/logo5.png" alt="" />
        </div>
