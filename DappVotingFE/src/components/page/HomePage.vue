<template>
  <div
    ...
    <div class="relative h-screen w-full overflow-hidden">
      ...
      <video class="absolute top-0 left-0 w-full h-full object-cover"
        src="https://metropolitanhost.com/themes/themeforest/html/vitto/assets/img/video-bg.mp4" autoplay muted
        loop></video>
      ...
      <div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-60">
        <div class="text-center">
          ...
          <p class="text-white font-bold text-lg mb-6">
            With blockchain technology, we will ensure transparency and fairness in elections.
          </p>
          <button
    ...
    <div class="mx-auto desktop:w-[1200px] max-sm:w-full sm:px-3 desktop:px-0">
      <div class="flex flex-col justify-center py-10 gap-6">
        <div class="text-center flex flex-col gap-2 justify-center items-center">
          ...
          <span class="font-bold text-4xl text-red-900">Our mission and vision</span>
          <span class="font-semiboldbold w-2/3 text-center text-gray-600">With blockchain technology, we will ensure
            transparency and
        ...
        <div class="grid grid-cols-3 gap-4">
          <div class="bg-white rounded-lg shadow-lg">
            ...
            <img class="w-full h-[250px] rounded-t-lg grayscale hover:grayscale-0 transition duration-300 ease-in-out"
              src="https://wp.xpeedstudio.com/electionify/wp-content/uploads/2019/12/mission-and-vission-1.png"
              alt="" />
            <div class="flex flex-col p-8 gap-4">
              <span class="font-bold text-red-900 text-lg">Equality and fairness</span>
              <span class="text-sm text-gray-500">With blockchain technology, I can ensure that elections are
                equal and fair.</span>
              <div
  ...
  <div
    ...
    <div class="bg-gradient-to-r bg-opacity-60 inset-0 min-h-[450px] w-full flex justify-center items-center">
  ...
  <div class="min-h-[450px] bg-cover bg-center ">
    <div class="mx-auto desktop:w-[1200px] max-sm:w-full sm:px-3 desktop:px-0 py-10">
      ...
      <div class="flex items-center justify-center mt-6">
        ...
        <div class="grid grid-cols-3 gap-4">
          <div v-for="(campaign, index) in visibleCampaigns" :key="index" class="bg-white rounded-lg shadow-lg p-8">
